...
st.sidebar.markdown('Este agente consulta o banco de dados do estoque, utilizando o modelo selecionado de LLM do GPT.')

st.write('Faça perguntas sobre o estoque de prodrutos, preços e reposições.')
...
Você fornecerá insights sobre produtos, preços, reposição de estoque e relatórios conforme solicitado pelo usuário.
A resposta final deve ter uma formatação amigável de visualização para o usuário.
Sempre responda perguntas em português brasileiro.
Pergunta: {q}
'''
